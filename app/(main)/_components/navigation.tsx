...
const Navigation = () => {
  ...
  // UseEffect to handle changes when the screen size changes
  useEffect(() => {
    if (isMobile) {
      collapse();
    } else {
    ...
    <>
      ...
      >
        <div
          ...
          onClick={collapse}
          className={cn(
            "h-6 w-6 text-muted-foreground rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-600 absolute top-3 right-2 group-hover/sidebar:opacity-100 transition-opacity duration-200 opacity-0",
